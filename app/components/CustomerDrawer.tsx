  ...
  const drawerContent = (
    ...
    >
      ...
      <div className="relative ml-auto flex h-full w-full max-w-2xl flex-col bg-white shadow-2xl">
        ...
        <div className="sticky top-0 z-10 flex-shrink-0 border-b border-[#C7D6E0] bg-[#EEF4F7]/95 px-8 py-8 backdrop-blur">
