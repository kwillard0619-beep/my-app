    ...
    <div className="min-h-screen bg-slate-100 py-2">
      <div className="mx-auto max-w-[1800px]">
        ...
        <div className="rounded-2xl border border-[#91AFC2] bg-[#B7CEDD] p-6 shadow-sm">
          ...
          <div className="mt-8 border-t border-[#91AFC2] pt-6">
            ...
            {/* ==================================================
                ...
                IMPORTANT:
                This is NOT absolute/fixed positioning.
                It remains in normal document flow and therefore
                pushes the table down when opened.
            ================================================== */}
                    ...
                    {advancedFilters.map(
                      (
                        ...
                        <div
                          ...
                          className="flex flex-col gap-3 rounded-xl border border-slate-200 bg-white p-4 xl:flex-row xl:items-center"
                        >
                          ...
                          <select
                            ...
                            className="min-w-0 flex-1 rounded-lg border border-slate-200 px-3 py-2 text-sm text-slate-700"
                          >
                            {filter.field ===
                            "category" ? (
                              availableCategories.map(
        ...
        {/* ==================================================
            ...
            This appears AFTER the filter panels in the DOM.
            Because the filter panels are in normal document
            flow, opening them pushes this table downward.
        ================================================== */}
